/* 
Документация для кастомной настройки: http://minetweaker3.powerofbytes.com/wiki/ModTweaker:Thaumcraft_4_Support:Research
...
Весь раздел разблокирован по умолчанию. При добавлении исследований необходимо изменить переменную unlock на false.
*/

# Название вкладки в таумономиконе
var tabName = "Draconic Evolution";

# Иконка вкладки в таумономиконе
var tabTextureMod = "draconicevolution";
var tabTextureSrc = "textures/items/draconic_Heart.png";
...
# Разблокирован ли раздел в таумономиконе 
var unlock = true;
